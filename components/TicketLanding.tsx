                  ...
                  <TouchableOpacity onPress={() => toggleTranslate(id, t.Subject, t["Case Description"])} style={{ padding: 6, marginLeft: 8 }}>
                    {trans.loading ? (
                      ...
                      <Svg width={18} height={18} viewBox="0 0 20 20">
                        <Defs>
                          <SvgLinearGradient id="translate-grad-landing" x1="0%" y1="0%" x2="100%" y2="0%">
                            <Stop offset="0%" stopColor="#B93F4B" />
                            <Stop offset="100%" stopColor="#451268" />
                          </SvgLinearGradient>
                        </Defs>
                        <Path d="M7.41 9l2.24 2.24-.83 2L6 10.4l-3.3 3.3-1.4-1.42L4.58 9l-.88-.88c-.53-.53-1-1.3-1.3-2.12h2.2c.15.28.33.53.51.7l.89.9.88-.88C7.48 6.1 8 4.84 8 4H0V2h5V0h2v2h5v2h-2c0 1.37-.74 3.15-1.7 4.12L7.4 9zm3.84 8L10 20H8l5-12h2l5 12h-2l-1.25-3h-5.5zm.83-2h3.84L14 10.4 12.08 15z" fill="url(#translate-grad-landing)" />
                      </Svg>
                    )}
                  </TouchableOpacity>
